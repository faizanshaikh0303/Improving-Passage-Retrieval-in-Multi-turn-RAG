...
def main():
    ...
    for collection_name in collections:
        ...
        if collection_name == "mt-rag-clapnq-hybrid":
            qrels_file = "./qrels/clapnq_dev.tsv"
        if collection_name == "mt-rag-govt-hybrid":
            qrels_file = "./qrels/govt_dev.tsv"
        if collection_name == "mt-rag-fiqa-hybrid":
            qrels_file = "./qrels/fiqa_dev.tsv"
        if collection_name == "mt-rag-cloud-hybrid":
            qrels_file = "./qrels/cloud_dev.tsv"
